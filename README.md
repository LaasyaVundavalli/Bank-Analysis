...
To analyze simulated Indian banking data and uncover key insights that can help drive strategic decisions such as:
- Identifying high-value customers
- Understanding transaction behaviors
- Measuring regional banking performance across Indian cities, with focus on Puducherry
- Detecting dormant and underutilized accounts
- Segmenting customers by digital channel adoption
...
- **Python** (psycopg2, matplotlib for visualization)
...
| Phase | Description |
|-------|-------------|
| **1. Data Modeling & Simulation** | Created 3 core tables: `customers`, `accounts`, `transactions` using realistic Indian names, cities (including Puducherry), account structures, and activity patterns. |
| **2. Data Querying** | Wrote 13 key SQL queries to extract insights and segment customer/account behavior, including digital channel adoption. |
| **3. Reporting & Export** | Documented insights with purpose-driven explanations; added CSV export instructions and JSON summary file. |
| **4. Visualization** | Created Python script for bar chart visualization of top customer segments. |
...
| 13 | **Digital-Only Customers** | Identify customers with >90% transactions via digital channels. |
...
- Developed Python scripts for database connectivity and data visualization.
- Gained deeper understanding of financial data behaviors — transaction types, account lifecycle, regional engagement, and digital adoption.
